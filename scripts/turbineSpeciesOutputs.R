...
sampledBirdParamsIters = data.frame(matrix(data = 0, ncol = 5, nrow = iter))
names(sampledBirdParamsIters) = c("Avoidance",  "WingSpan", "BodyLength", "FlightSpeed", "PropUpwind")
...
sampledBirdParamsIters[, 5] = sampledBirdParams$PropUpwind
...
sampledTurbineParamsSummary[, 1] = c("RotorRadius_m", "HubHeight_m", "BladeWidth_m", "WindSpeed_mps", "RotorSpeed_rpm", "Pitch_rad", "WFWidth_km", 
                                     "Latitude", "Longitude", "Num_Turbines", "JanOp", "FebOp", "MarOp", "AprOp", "MayOp", "JunOp", "JulOp", 
...
sampledTurbineParamsIters[, 7] = TurbineData$WFWidth_km[t]
sampledTurbineParamsIters[, 8] = TurbineData$Latitude[t]
sampledTurbineParamsIters[, 9] = TurbineData$Longitude[t]
sampledTurbineParamsIters[, 10] = TurbineData$Num_Turbines[t]
