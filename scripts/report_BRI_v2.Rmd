...
kbl(all_models_summary, booktabs=T, caption = "The predicted mean and 95 perc. prediction intervals of the number of collisions per month. Results are not shown for months that do not have movement data.") %>%
  kable_styling(position="left", full_width=F, latex_options = c("HOLD_position", "striped")) %>% 
